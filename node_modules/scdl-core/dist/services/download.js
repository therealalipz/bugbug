...
var getTrackStream = function (url, downloadOptions) {
    try {
        return m3u8stream.default(url, {
            highWaterMark: (downloadOptions === null || downloadOptions === void 0 ? void 0 : downloadOptions.highWaterMark) || 16 * 1024,
        });
    }
    catch (e) {
        throw "Invalid url";
...
var download = function (clientId, url, downloadOptions) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, tracks_1.getTrack)(clientId, url)];
            case 1:
                track = _a.sent();
