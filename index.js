...
connectOptions,
areJidsSameUser 
} = require("./lib/woker/@adiwajshing/baileys")
...
const { sleep, getBuffer, banner, start, success, getRandom, getGroupAdmins, close } = require("./lib/functions");
...
const connectionOptions = {
  ...
  auth: state,
  browser: ['Extream', `${randomserverku}`, '3.0'], 
}
...
require('./Fan.js')(conn, m, chatUpdate,store)
}catch (err){
console.log(err)
}
})
